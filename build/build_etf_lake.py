...
## 🔴 ETF 价格刻度：源头有个补丁，链条上必须有那一步

通达信 2026-05-25 改了 ETF 的价格编码，tdx2db 的二进制解析没跟上 —— 抓进来的
ETF 价格一律是真实值的 **1/10**。修法是 `tdx2db/scripts/fix_etf_price_scale.py`
（×10 + 重算 basic_daily 的 preclose/change_pct，按 `_etf_scale_fixed` 幂等）。
